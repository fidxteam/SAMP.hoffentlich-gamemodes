...
CreateServerPoint()
{
	...
	//Server Money
	new strings[1024];
	MoneyPickup = CreateDynamicPickup(1239, 23, 1412.1685, -999.0665, 10.8763, -1, -1, -1, 50.0);
	format(strings, sizeof(strings), "[Server Money]\n"WHITE_E"Goverment Money: "LG_E"%s", FormatMoney(ServerMoney));
	MoneyText = CreateDynamic3DTextLabel(strings, COLOR_LBLUE, 1412.1685, -999.0665, 10.8763, 5.0);
	...
	ApotekPickup = CreateDynamicPickup(1241, 23, 1299.637573, -1482.065307, 1019.413940, -1, -1, -1, 50.0);
	format(strings, sizeof(strings), "[Hospital]\n"WHITE_E"Apotek Stock: "LG_E"%d\n"LB_E"/buy", Apotek);
	ApotekText = CreateDynamic3DTextLabel(strings, COLOR_PINK, 1299.637573, -1482.065307, 1019.413940, 5.0); // Apotek hospital
	...
	ObatPickup = CreateDynamicPickup(1241, 23, 1322.430053, -1493.249267, 1019.413940, -1, -1, -1, 50.0);
	...
	ObatText = CreateDynamic3DTextLabel(strings, COLOR_GREY, 1322.430053, -1493.249267, 1019.413940, 5.0); // product
...
Server_Save()
{
	...
	Food, FoodPrice, SeedPrice, PotatoPrice, WheatPrice, OrangePrice, Marijuana, MarijuanaPrice, FishPrice, GStationPrice, ObatMyr, Ayamhidup, kandang1, kandang2, kandang3, kandang4, kandang5, Ayammati, Ayampaket, Ayambiasa,ObatPrice, MekaMoney, MekaKompo);
...
function LoadServer()
{
	...
	cache_get_value_name_int(0, "ayam", Ayamhidup);
	cache_get_value_name_int(0, "kandang1", kandang1);
	cache_get_value_name_int(0, "kandang2", kandang2);
	cache_get_value_name_int(0, "kandang3", kandang3);
	cache_get_value_name_int(0, "kandang4", kandang4);
	cache_get_value_name_int(0, "kandang5", kandang5);
	cache_get_value_name_int(0, "ayammati", Ayammati);
	cache_get_value_name_int(0, "ayampaket", Ayampaket);
	cache_get_value_name_int(0, "ayambiasa", Ayambiasa);
	cache_get_value_name_int(0, "mekamoney", MekaMoney);
	cache_get_value_name_int(0, "mekakompo", MekaKompo);
